...
def encode_plot(P, pad=None, pad_inches=0.1, bbox_inches=None, remove_axes = False, dpi=None):
    """
    ...
    fig.savefig(virtual_file, format='png', pad_inches=pad_inches, bbox_inches=bbox_inches, dpi=dpi)
    virtual_file.seek(0)
